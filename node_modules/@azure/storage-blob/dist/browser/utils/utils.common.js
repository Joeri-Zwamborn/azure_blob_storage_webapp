 ...
 */
export function resolveResponseFormat(responseFormat) {
...
export async function setUploadChecksumParameters(body, contentLength, parameters, uploadOptions, configContentChecksumAlgorithm) {
