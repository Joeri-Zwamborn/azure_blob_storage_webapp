...
import type { Metadata, ObjectReplicationPolicy, Tags, ContainerRequestConditions, ModifiedAccessConditions, BlobClientConfig, ContainerClientOptions } from "./models.js";
...
export declare class ContainerClient extends StorageClient {
     ...
     * @param options - Options to Container List Blob Flat Segment operation.
     */
    private listBlobFlatSegmentApacheArrow;
    /**
     ...
     * @param options - Options to Container List Blob Hierarchy Segment operation.
     */
    private listBlobHierarchySegmentApacheArrow;
    /**
