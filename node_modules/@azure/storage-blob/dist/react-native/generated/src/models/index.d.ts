...
/** Optional parameters. */
export interface ContainerListBlobFlatSegmentApacheArrowOptionalParams extends coreClient.OperationOptions {
    /** The timeout parameter is expressed in seconds. For more information, see <a href="https://learn.microsoft.com/rest/api/storageservices/setting-timeouts-for-blob-service-operations">Setting Timeouts for Blob Service Operations.</a> */
    timeoutInSeconds?: number;
    /** Provides a client-generated, opaque value with a 1 KB character limit that is recorded in the analytics logs when storage analytics logging is enabled. */
    requestId?: string;
...
export type ContainerListBlobFlatSegmentApacheArrowResponse = ContainerListBlobFlatSegmentApacheArrowHeaders & {
    /**
     * BROWSER ONLY
     *
     * The response body as a browser Blob.
...
/** Optional parameters. */
export interface ContainerListBlobHierarchySegmentApacheArrowOptionalParams extends coreClient.OperationOptions {
    /** The timeout parameter is expressed in seconds. For more information, see <a href="https://learn.microsoft.com/rest/api/storageservices/setting-timeouts-for-blob-service-operations">Setting Timeouts for Blob Service Operations.</a> */
    timeoutInSeconds?: number;
    /** Provides a client-generated, opaque value with a 1 KB character limit that is recorded in the analytics logs when storage analytics logging is enabled. */
    requestId?: string;
...
export type ContainerListBlobHierarchySegmentApacheArrowResponse = ContainerListBlobHierarchySegmentApacheArrowHeaders & {
    /**
     * BROWSER ONLY
     *
     * The response body as a browser Blob.
