...
export declare function setUploadChecksumParameters(body: HttpRequestBody, contentLength: number, parameters: UploadChecksumParametersLike, uploadOptions: UploadChecksumParametersLike, configContentChecksumAlgorithm?: StorageChecksumAlgorithm): Promise<UploadCheckSumBody>;
export {};
